...
public class Bai1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ket qua so sanh bang cua 2 so " + firstNumber + " và " +
                secondNumber + " là " + (firstNumber == secondNumber));
        System.out.println("Ket qua so sanh khong bang cua 2 so " + firstNumber + " và " +
                secondNumber + " là " + (firstNumber != secondNumber));
        System.out.println("Ket qua so sanh lon hon cua 2 so " + firstNumber + " và " +
                secondNumber + " là " + (firstNumber > secondNumber));
        System.out.println("Ket qua so sanh lon hon hoac bang 2 so " + firstNumber + " và " +
                secondNumber + " là " + (firstNumber >= secondNumber));
        System.out.println("Ket qua so sanh nho hon 2 so " + firstNumber + " và " +
                secondNumber + " là " + (firstNumber < secondNumber));
        System.out.println("Ket qua so sanh nho hon hoac bang 2 so " + firstNumber + " và " +
                secondNumber + " là " + (firstNumber <= secondNumber));
    }
